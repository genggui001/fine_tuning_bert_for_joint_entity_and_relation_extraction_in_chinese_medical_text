...
class Embedding:
    def __init__(self, output_dim: int = 768, dropout: float = 0.1, vocab_size: int = 30000 + TextEncoder.SPECIAL_COUNT,
                 ...
                 use_embedding_layer_norm: bool = False, layer_norm_epsilon: float = 1e-5, type_vocab_size=TextEncoder.NUM_SEGMENTS, **kwargs):
        ...
        self.segment_emb = keras.layers.Embedding(type_vocab_size, output_dim, input_length=max_len,
